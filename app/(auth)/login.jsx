...
const login = () => {
    ...
    return (
        <SafeAreaView className="flex-1 bg-black">
             ...
             <View className="flex-1 justify-center items-center px-5 relative z-10">
                <Image
                ...
                <View className="w-full space-y-4 -mt-10">
                    ...
                    <TouchableOpacity className="bg-orange-500 w-full py-3 rounded-full mt-4">
                    ...
                    <View className="flex flex-row justify-center items-center space-x-1 mt-4">
                        <Text className="text-white">Doesn't have an account?</Text>
                        <TouchableOpacity onPress={() => router.push("/signup")}>
                            <Text className="text-orange-500 font-medium ml-1">Signup</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </View>
